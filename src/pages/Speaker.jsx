...
const SpeakerSession = () => {
  return (
    <div className="min-h-screen bg-black py-8 sm:py-14 px-4 sm:px-6">
      <motion.div
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
      ...
      >
        ...
        >
          ...
          <div className="w-24 sm:w-32 h-1 bg-blue-500 mx-auto" />
        </motion.div>
          ...
          >
            ...
            <div className="flex flex-wrap gap-4 sm:gap-6 lg:gap-8">
              <div className="flex items-center space-x-2 text-gray-300">
                ...
                <span className="text-base sm:text-lg">5 April, 2024</span>
              </div>
              <div className="flex items-center space-x-2 text-gray-300">
                <Clock className="text-blue-500" size={20} />
                <span className="text-base sm:text-lg">2 Hours</span>
              </div>
              <div className="flex items-center space-x-2 text-gray-300">
                <Users className="text-blue-500" size={20} />
                <span className="text-base sm:text-lg">50 + </span>
              </div>
              <a 
              ...
              >
                <Link2 size={20} />
                <span className="text-base sm:text-lg">Event Details</span>
              </a>
            </div>

            <div className="space-y-4 sm:space-y-5">
              <p className="text-gray-300 leading-relaxed text-sm sm:text-md">
                I had the incredible opportunity to conduct a speaker session alongside <span className="font-bold text-base sm:text-lg">Manav Ailawadi, co-founder of Blockchained India</span>, as part of the
                <span className="font-bold text-base sm:text-lg"> Blockchain Bytes India series</span>.
              </p>
              <p className="text-gray-300 leading-relaxed text-sm sm:text-md">
                The session was structured into two insightful parts:
              </p>
              <ul className="list-disc pl-6 sm:pl-8 text-gray-300 space-y-2">
